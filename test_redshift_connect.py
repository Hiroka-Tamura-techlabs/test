...
a = pd.DataFrame(run_query("select the_store_id,business_date,meal_time,release_branch,escalation_type from pa_prod.quicksight_golden_arches;"),columns=['the_store_id','business_date','meal_time','release_branch','escalation_type'])
